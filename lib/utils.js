...
function printHeader(version) {
  ...
  console.log(line);
  console.log(c.blue(`  DevFlow Pro v${version}`));
  console.log(line);
  console.log();
}
...
function printSuccess(version) {
  ...
  console.log();
  console.log(line);
  console.log(c.green(`  \u2713 DevFlow Pro v${version} installed successfully!`));
  console.log(line);
  console.log();
}
...
function printUpdateSuccess(version) {
  ...
  console.log();
  console.log(line);
  console.log(c.green(`  \u2713 DevFlow Pro updated to v${version}!`));
  console.log(line);
  console.log();
}
