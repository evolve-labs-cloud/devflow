# DevFlow v1.2.6 - Sistema Multi-Agentes para Desenvolvimento de Software
...
[![Version](https://img.shields.io/badge/version-1.2.6-blue.svg)](docs/CHANGELOG.md)
...
| **v1.2.6**    | **Spawn templates com contexto obrigatorio para teammates** |
...
**DevFlow v1.2.6** - Desenvolvido por [Evolve Labs](https://plataforma.evolvelabs.cloud)
